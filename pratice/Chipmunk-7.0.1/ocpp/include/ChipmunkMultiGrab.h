...
class ChipmunkGrab :public ChipmunkObject {
private:
	std::std::vector<ChipmunkObject*> _chipmunkObjects;
	cpVect _pos;
	cpFloat _smoothing;
...
private:
	...
	std::vector<ChipmunkGrab*> _grabs;
...
public:
	...
	cpFloat pushMass;
	cpFloat pushFriction;
	cpFloat pushElasticity;
	cpCollisionType pushCollisionType;

	std::vector<ChipmunkGrab*> grabs;
	...
	ChipmunkMultiGrab* initFor(ChipmunkSpace *space,cpFloat withSmoothing,cpFloat withGrabForce);

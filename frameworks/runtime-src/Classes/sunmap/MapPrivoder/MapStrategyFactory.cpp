...
int MapStrategyFactory::SMCLOUD_VECTOR= 9;
int MapStrategyFactory::Stamen = 10;
int MapStrategyFactory::SkyDream = 11;
...
void MapStrategyFactory::initMapStrategy()
{
	...
	MapStrategyFactory::m_mapStrategy.insert(std::map<int, MapStrategy*>::value_type(MapStrategyFactory::Stamen, new StamenStreetMapStategy()));
	MapStrategyFactory::m_mapStrategy.insert(std::map<int, MapStrategy*>::value_type(MapStrategyFactory::SkyDream, new SkyDreamMap()));
}

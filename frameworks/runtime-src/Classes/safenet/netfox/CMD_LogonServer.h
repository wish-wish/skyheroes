...
//登录结果
#define SUB_GP_LOGON_SUCCESS		130									//登录成功
#define SUB_GP_LOGON_FAILURE		131									//登录失败
#define SUB_GP_LOGON_FINISH			132									//登录完成
#define SUB_GP_VALIDATE_MBCARD      133                                 //登录失败
...
struct CMD_GP_RegisterAccounts
{
	...
	WORD							wDeviceType;						//登陆终端
	WORD							wRegisterType;						//登录类型（0-游客登录、1-FB登录、2-瑞奇平台登录）
	char							szFaceCode[LEN_MD5];				//头像ID
};

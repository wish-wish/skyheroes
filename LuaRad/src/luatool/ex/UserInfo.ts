export class UserInfo
{
    ...
    constructor(info)
    {
        ...
        }else
        {
            ...
            this.uuid = info.uuid==null?this.createUuid():info.uuid
            this.donateShowMonth = info.donateShowMonth==null?"":info.donateShowMonth
            this.showIndex = info.showIndex==null?0:info.showIndex
        }
    }

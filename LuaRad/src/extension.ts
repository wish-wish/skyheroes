...
import { RadCompletionItemProvider } from "./luatool/provider/RadCompletionItemProvider";
...
export function activate(context: vscode.ExtensionContext) {
	...
	fs.writeFileSync(configpath,context.extensionPath);

	if((luaRadExtension != null && luaRadExtension.isActive) || (luaRadExtension != null && luaRadExtension.isActive)){
		return;
	}
	...
	//context.subscriptions.push(vscode.languages.registerCompletionItemProvider(LUA_MODE,new RadCompletionItemProvider
	//	,".",":",'"',"[","@"));
	...
	vscode.workspace.onDidChangeTextDocument(event => {
		...
		if (ExtensionManager.em.luaRadConfigManager.changeTextCheck) {
